const palette = {
  ...
  MEMBER: 'border-sky-300/35 bg-sky-300/15 text-sky-100',
  SELLER: 'border-emerald-300/35 bg-emerald-300/15 text-emerald-100',
  ADMIN: 'border-fuchsia-300/35 bg-fuchsia-300/15 text-fuchsia-100',
  Locked: 'border-rose-300/30 bg-rose-300/10 text-rose-100',
